...
export const getStockItems = async (lowStockThreshold = 10): Promise<ApiResponse<{items: StockItem[], lowStockCount: number}>> => {
  try {
    ...
    const mockStockData: StockItem[] = [
      { id: 1, nome: 'Tomate', quantidade: 50, unidade: 'kg', valor_unitario: 4.50, categoria: 'Vegetais' },
      { id: 2, nome: 'Carne Bovina', quantidade: 5, unidade: 'kg', valor_unitario: 32.00, categoria: 'Carnes' },
      { id: 3, nome: 'Queijo Mussarela', quantidade: 8, unidade: 'kg', valor_unitario: 28.00, categoria: 'Laticínios' }
    ];
