        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#cardapio" className="text-gray-600 hover:text-gray-900">
                Cardápio
              </a>
            ...
            {destaques.map((destaque, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">{destaque.titulo}</h3>
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="flex items-center">{renderEstrelas(avaliacao.estrelas)}</div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/reserva" className="text-gray-400 hover:text-white">
                    Reservas
                  </Link>
                </li>
              </ul>
