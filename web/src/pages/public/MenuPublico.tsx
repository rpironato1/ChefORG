...
const mockMenuItems: MenuItem[] = [
  {
    ...
    descricao:
      'Hambúrguer de carne bovina 180g com queijo artesanal, alface, tomate, cebola caramelizada e molho especial da casa',
    preco: 28.9,
    categoria: 'Lanches',
    disponivel: true,
    tempo_preparo: 15,
  ...
  },
  {
    ...
    descricao:
      'Risotto cremoso preparado com arroz arbóreo, camarões frescos, vinho branco e temperos especiais',
    preco: 45.5,
  ...
  },
  {
    ...
    descricao:
      'Alface romana fresca, croutons dourados, lascas de parmesão e molho caesar tradicional',
    preco: 22.8,
    categoria: 'Entradas',
    disponivel: true,
    tempo_preparo: 10,
  ...
  },
  {
    ...
    descricao:
      'Fatias de pão italiano tostado com tomates frescos, manjericão e azeite extravirgem',
    preco: 18.5,
    categoria: 'Entradas',
    disponivel: true,
    tempo_preparo: 8,
  ...
  const getItemsPorCategoria = () => {
    ...
    if (categoriaAtiva === 'Todas') {
      categorias.slice(1).forEach(categoria => {
        resultado[categoria] = mockMenuItems.filter(
          item =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-primary-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Descubra nossa seleção especial de pratos preparados com ingredientes frescos e técnicas
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mt-12 text-center">
          ...
          <Link to="/reserva" className="btn-primary text-lg px-8 py-4">
            Fazer Reserva
          </Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Todos os pratos são preparados
                <br />
                na hora com ingredientes frescos
                <br />
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Aceitamos dinheiro, cartões
                <br />
                PIX, Apple Pay, Google Pay
                <br />e Samsung Pay
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-4">Experiência gastronômica única • (11) 3333-4444</p>
