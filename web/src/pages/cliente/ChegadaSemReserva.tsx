        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-2">Na Fila de Espera</h1>
              <p className="text-gray-600 mb-8">
                Você foi adicionado à nossa fila virtual. Será notificado quando sua mesa estiver
                pronta.
              </p>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm">
                  <p className="font-medium text-green-800 mb-1">Notificação por WhatsApp</p>
                  <p className="text-green-700">
                    Enviaremos uma mensagem para <strong>{formData.telefone}</strong> quando sua
                    mesa estiver pronta.
                  </p>
                </div>
              </div>
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Chegada sem Reserva</h1>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p>
                  Você será adicionado à nossa fila virtual e receberá uma notificação por WhatsApp
                  quando uma mesa estiver disponível.
                </p>
              </div>
            </div>
          </div>
